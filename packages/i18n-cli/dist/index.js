...
var toAbsolutePath = (path$1) => path.resolve(appRootPath, toRelativePath(path$1));
...
async function generateTranslationsFile(params) {
  ...
  try {
    ...
    await promises.writeFile(translationsFilePath, prettyCode);
  } catch (err) {
...
Object.defineProperty(exports, "TECH_LOCALE", {
  enumerable: true,
  get: function () { return i18nTypes.TECH_LOCALE; }
});
exports.createSourceVisitors = createSourceVisitors;
exports.defineConfig = defineConfig;
exports.generateTranslationsFile = generateTranslationsFile;
exports.generateTranslationsFileContent = generateTranslationsFileContent;
exports.loadProjectConfig = loadProjectConfig;
exports.parseProjectTranslations = parseProjectTranslations;
exports.parseTranslationsFile = parseTranslationsFile;
