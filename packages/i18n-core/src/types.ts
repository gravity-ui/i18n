import type {
    CustomFormats as CoreCustomFormats,
...
export interface ResolvedIntlConfigWithLocale<TBase, AvailableLocale extends string>
    extends ResolvedIntlConfig<TBase, AvailableLocale> {
...
export type IntlFormatters<TBase> = Pick<
    IntlFormattersFull<TBase>,
    | 'formatNumber'
    | 'formatNumberToParts'
    | 'formatDisplayName'
    | 'formatList'
...
export type Formatters = Pick<
    CoreFormatters,
    'getNumberFormat' | 'getMessageFormat' | 'getPluralRules' | 'getListFormat' | 'getDisplayNames'
>;
